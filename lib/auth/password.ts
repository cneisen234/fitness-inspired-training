...
// the Edge proxy). There is one admin (Ashley) and no user table: the password is
// compared against a bcrypt hash held in ADMIN_PASSWORD_HASH. Generate the hash
